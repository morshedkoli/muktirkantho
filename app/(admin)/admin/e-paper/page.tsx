  ...
  return (
    <div className="w-full min-w-0 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <div className="font-editorial-mono text-[10px] tracking-[3px] uppercase text-[var(--ad-breaking)]">Content</div>
          <h1 className="font-editorial-display text-2xl font-black text-[var(--ad-text-primary)]">E-Paper Upload</h1>
        </div>
      </div>

      <div className="border border-[var(--ad-border)] bg-[var(--ad-card)] p-12 text-center">
        <BookOpen className="mx-auto h-12 w-12 text-[var(--ad-muted)] mb-4" />
        ...
        <p className="text-sm text-[var(--ad-text-secondary)] max-w-md mx-auto">
          The E-Paper module will allow PDF upload with date-based browsing, page flip viewer, and print edition management.
        </p>
      </div>
    </div>
  );
